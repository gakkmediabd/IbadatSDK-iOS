...
class IslamicCalenderVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(HolidayHeader.nib, forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: HolidayHeader.identifier)
...
extension IslamicCalenderVC : UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UICollectionViewDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        if kind == UICollectionElementKindSectionHeader{
            guard let header = collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionElementKindSectionHeader, withReuseIdentifier: HolidayHeader.identifier, for: indexPath) as? HolidayHeader else {
                fatalError()
            }
            return header
        }
