...
{   
    ...
    ff.calendar = [[NSCalendar alloc] initWithCalendarIdentifier:NSCalendarIdentifierIslamicUmmAlQura];
    NSDate* min = [ff dateFromString:@"1400-01-01"];
    NSDate* max = [ff dateFromString:@"1500-01-01"];
    
    _minimumDate = min; //[self.formatter dateFromString:@"1400-01-01"];
    _maximumDate = max; //[self.formatter dateFromString:@"1500-01-01"];
...
- (BOOL)requestBoundingDatesIfNecessary
{
    if (_needsRequestingBoundingDates) {
        ...
        NSDate *newMax = [self.dataSourceProxy maximumDateForCalendar:self]?:[self.formatter dateFromString:@"1500-12-31"];
